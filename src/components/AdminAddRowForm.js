		...
		return (
			<div className = "PageContainer">
				...
				<section>
					...
					<Modal
						show={this.state.autoModal}
						onHide={this.autoModalClose}
						centered
					>
						<Modal.Header closeButton></Modal.Header>
						<Modal.Body>
							<p>Would you like to schedule your survey to start at 12:00AM on {this.state.start_date} and end at 11:59PM on {this.state.end_date}?</p>
						</Modal.Body>
						<Modal.Footer>
							<Button variant="gray" onClick={this.autoModalClose}>Close</Button>
							<Button variant="red" onClick={this.autoModalClose} href="/scheduled" >OK</Button>
						</Modal.Footer>
					</Modal>
					<Modal
						show={this.state.manualModal}
						onHide={this.manualModalClose}
						centered
					>
						<Modal.Header closeButton></Modal.Header>
						<Modal.Body>
							<p>
								Would you like to start the survey collection period immediately?
							</p>
						</Modal.Body>
						<Modal.Footer>
							<Button variant="gray" onClick={this.manualModalClose}>Close</Button>
							<Button variant="red" onClick={this.manualModalClose} href="/active" >OK</Button>
						</Modal.Footer>
					</Modal>
				</section>
			</div>
